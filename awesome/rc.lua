...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "term", "dev", "web", "mail", "im", "mp3", "files", 8, 9 }, s, layouts[2])
end
-- }}}
...
--  { rule = { class = "Thunderbird" }, properties = { tag = tags[1][4] } },
    ...
    { rule = { class = "Rocket.Chat" }, properties = { tag = tags[1][5] } },
    { rule = { class = "Rhythmbox"   }, properties = { tag = tags[1][6] } },
}
-- }}}
